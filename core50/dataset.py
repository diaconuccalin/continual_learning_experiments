...
class CORE50(object):
    ...
    Args:
        ...
        preload (string, optional): If True data is preloaded with look-up
        ...
        start_batch (int, optional): One of the training incremental batches
            ...
            incremental batches.
        demo (bool, optional): Flag to mark if dataset should be loaded in demo mode.
    """
    ...
    def __init__(self, root='', preload=False, scenario='ni', cumul=False,
                 run=0, start_batch=0, task_sep=False, demo=False):
        """" Initialize Object """
    ...
    def __next__(self):
        ...
        if self.demo:
            train_idx_list = random.sample(train_idx_list, 1)
        ...
        if self.demo:
            train_y = train_y[int(train_idx_list[0])]
